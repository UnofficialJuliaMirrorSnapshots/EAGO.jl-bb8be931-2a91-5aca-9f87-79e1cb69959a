...
function build_evaluator!(d::ImplicitLowerEvaluator, impfun::Function, np::Int, nx::Int;
    ...
    d.state_ref_relaxation = Vector{MC{np}}[MC{np}[zero(MC{np}) for i in 1:nx] for j in 1:d.imp_opts.kmax+1]
...
function relax_implicit!(d::ImplicitLowerEvaluator,y)
    ...
    if ~is_same_box
        ...
        if (nx > 0)
            gen_expansion_params!(d.state_fun, d.state_jac_fun, d.ref_pMC, d.state_relax, d.xa_mc, d.xA_mc, d.z_mc, d.aff_mc, d.X, d.P, d.imp_opts, d.state_ref_relaxation, d.H, d.J, d.Y, true)
        end
    end
    ...
    for i in 1:nx
        ...
        if (nx > 0)
            implicit_relax_h!(d.state_fun, d.state_jac_fun, pMC, d.ref_pMC, d.state_relax, d.xa_mc, d.xA_mc, d.z_mc, d.aff_mc, d.X, d.P, d.imp_opts, d.state_ref_relaxation, d.H, d.J, d.Y, true)
        end
#    else
...
function relax_constraints!(d::ImplicitLowerEvaluator)
    if ~d.cnstr_eval
        eval_val  = d.constraints_fun(d.state_relax,d.var_relax)
